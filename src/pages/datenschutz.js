...
<section class="section section--tight" style="padding-top:0"><div class="container prose">
  ...
  <h2>8. Aktualität</h2>
  <p>Diese Datenschutzerklärung ist aktuell gültig und hat den Stand ${ph('Monat Jahr')}. Wir passen sie an, wenn sich unsere Website oder die Rechtslage ändert.</p>
</div></section>`;
  },
};
